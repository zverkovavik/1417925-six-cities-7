...
import CardForRoomComponent from './card-for-room-component';
...
describe('Component: CardForRoomComponent', () => {
  beforeAll(() => {
  ...
  it('should render correctly', () => {
    ...
    expect(screen.getByText(/Wonderfull place/i)).toBeInTheDocument();
